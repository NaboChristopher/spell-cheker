...
function wordTyped() {
    ...
    const split_input = input.split(/\s+/);
    let new_word = [split_input];
    new_word.forEach(element => console.log(element));
...
function displayRecommendation(new_word) {
    if (rList.length > 0) {
        ...
        var code_out = "<p class='lead' style='color: #777777;'></p><span class='list-group' style='max-width: 250px; display: block; box-shadow: 2px 2px 5px #EEE;'>";
